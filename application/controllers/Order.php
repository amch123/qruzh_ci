...
'; 
	...
	public function store()
	{
		...
		{
			$tax = ($this->shop2->total_cart() * 12)/100;
			...
			$data = array(
						...
						'subtotal' => $this->shop2->total_cart(),
						'total_tax' => $tax,
						'total_shipping' => $_SESSION['shipping_price'],
						'total_amount' => $tax + $_SESSION['shipping_price'] + $this->shop2->total_cart()
					);
		...
		if($data['status'] == true)
		{
			...
			$this->email->subject('Orden de Compra MobilePhone');
