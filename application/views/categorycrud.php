    ...
    <div role="main" class="main">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <a href="<?php echo base_url(); ?>index.php/account/category/create"><button type="button" class="btn btn-default mr-xs mb-sm">Agregar Categoría</button></a></i></button>
                    <hr>
                    <?php 
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>index.php/account/category/edit/<?php echo $category->id_category; ?>">
                                                <i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a href="<?php echo base_url(); ?>index.php/account/category/delete/<?php echo $category->id_category; ?>">
