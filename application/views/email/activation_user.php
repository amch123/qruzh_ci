                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <p align="center" style="margin:0 0 10px; font-size:12px; line-height:18px; color:#333333;">Compruebe que el correo
                                                                        electrónico angelicacovahuerta@gmail.com
                                                                        es suyo, </p>
                                                            <p align="center" style="margin:0 0 10px; font-size:12px; line-height:18px; color:#333333;">para completar la activación de
                                                                        su cuenta.</p>
                                                            ...
                                                            <p align="center" style="margin:0 0 10px; font-size:12px; line-height:18px; color:#333333;">
                                                                        <input type="buttom" value="Verificar Email" class="Estilo3" data-loading-text="Loading...">
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px;line-height:1px;">&nbsp;</p>
