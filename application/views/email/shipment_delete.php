                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:0">
                                                <!-- inicio contenido -->
                                                <a href="#"><img src="<?php echo base_url(); ?>template/img/template/img/header.jpg" width="600" alt="" style="display:block; border:0; margin:0 0 44px; background:#ffffff;"></a>                                                <!-- inicio articulos -->
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr valign="top">
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <p align="center" style="margin:0 0 10px; font-size:20px; line-height:18px; color:#333333;">Su envio fue eliminado. </p>
                                                            <p>&nbsp;</p>
                                                            <p>&nbsp;</p>
                                                            </td>
                                                            <td width="30"><p style="margin:0; font-size:1px;line-height:1px;">&nbsp;</p>
