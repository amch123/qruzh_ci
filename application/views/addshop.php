                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb breadcrumb-valign-mid">
                                <li><a href="<?php echo base_url(); ?>index.php/account/shop/create">Agregar Tienda</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-10">
                                <div class="featured-box featured-box-primary align-left mt-xlg">
                                    <div class="box-content">
                                        <form action="<?php echo base_url(); ?>index.php/account/shop/store" id="frmSignUp" method="post">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="shop_name" value="" class="form-control input-lg" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
